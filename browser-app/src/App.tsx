...
const MonitorsView = lazy(() =>
  import("./components/monitors/MonitorsView").then((m) => ({ default: m.MonitorsView }))
);
...
const ExtensionsPanel = lazy(() =>
  import("./components/extensions/ExtensionsPanel").then((m) => ({ default: m.ExtensionsPanel }))
);
